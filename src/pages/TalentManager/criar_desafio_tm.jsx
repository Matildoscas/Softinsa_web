...
function normalizarConsultor(
  ...
  return {
    ...
    nome_nivel:
      consultor.nome_nivel ||
      consultor.nivel_atual ||
      "Não disponível",

    total_badges:
      Number(
        consultor.total_badges ||
        consultor.badges_conquistados_total ||
        0
      ),

    pontos_atuais:
      Number(
        consultor.pontos_atuais ||
        0
      ),
...
function CriarDesafioTm() {
  ...
  const idConsultorInicial =
    location.state?.idConsultor ||
    "";
  ...
  async function carregarDados() {
    try {
      ...
      console.error(
        "Erro ao carregar criação de desafio:",
        err
      );
  ...
  function selecionarBadge(
    ...
    setTitulo(
      `Concluir o badge ${badge.nome_badge}`
    );
          ...
          <div style={cabecalho}>
            ...
            <div>
              ...
              <div style={subtituloPagina}>
                Define um badge e um
                prazo para o consultor.
                O desafio será enviado
                para aceitação.
              </div>
            </div>
          </div>
...
function PontosCard({
  ...
  return (
    ...
    >
      ...
      <div style={pontosValor}>
        {valor}
      </div>

      <div style={pontosTexto}>
        pontos
      </div>
    </div>
  );
