...
function InformacaoConsultorTm() {
  ...
  async function carregarPerfil() {
    ...
    try {
      ...
      const response =
        await api.get(
          `/tm/${idUtilizadorTm}/consultores/${idConsultor}`
        );
  ...
  const candidaturaAtual =
    dados?.candidatura_atual ||
    null;

    const idCandidaturaDetalhe =
    location.state?.idCandidaturaOrigem ||
    candidaturaAtual?.id_candidatura_pedido;
    ...
    try {
      ...
      autoTable(pdf, {
        ...
        body: [
          ...
          [
            "Pontos totais",
            estatisticas.total_pontos,
          ],
          [
            "Badges totais",
            estatisticas.total_badges,
          ],
          [
            "Conquistas especiais",
            estatisticas
              .conquistas_especiais,
          ],
          [
            "Learning Paths completas",
            estatisticas
              .learning_paths_completas,
          ],
        ],
            ...
            <>
              ...
              <section style={estatisticasCard}>
                ...
                <div style={estatisticasGrid}>
                  <Estatistica
                    valor={`${estatisticas.total_pontos} pts`}
                    label="Pontos Totais"
                  />
                ...
                {candidaturaAtual ? (
                  <div style={processoConteudo}>
                    ...
                    onClick={() => {
                        ...
                        navigate(
                        `/tm/solicitacoes/${idCandidaturaDetalhe}`,
                        {
                            state: {
                            voltarPara:
                                location.pathname,
